...
<body>
    <nav class="navbar navbar-dark bg-dark">
        <div class="container">
            ...
            <button class="btn my-2 my-sm-2 text-white" style="background-color: red;" type="button"><a
                    href="login-admin.php" class="text-white">
                    Login
                </a></button>
        </div>
    </nav>
    ...
    <div class="container">
        ...
        <div class="mt-5">
            ...
            <form class="form my-2">
                <input class="form-control mr-sm-2" type="text" placeholder="Masukkan ID Surat yang ingin di Lacak"
                    aria-label="Search" name="id">
                <div class="width-100 text-center">
                    <button class="btn my-2 my-sm-2 mx-auto text-white" style="background-color: red;"
