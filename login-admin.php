...
<body class="text-center">
    <form class="form-signin" method="post">
        ...
        <img class="mb-4" src="assets/kab-kudus.png" alt="" width="120" height="120">
        <h1 class="h3 mb-3 font-weight-normal">Please sign in</h1>
        <label for="inputUsername" class="sr-only">Username</label>
        <input type="text" id="inputUsername" class="form-control" placeholder="Username" name="nama" required autofocus>
