                ...
                <form method="post" id="mainform" enctype="multipart/form-data">
                    <div class="row">
                        <div class='col-md-6'>
                            ...
                            <div class="form-group has-feedback" align="left">
                                ...
                                <input name="id_input" required type="text" class="form-control"
                                    placeholder="Masukkan Nomor ID Permohonan" value="<?php echo  $id ?>" disabled>
                                <input name="id_input" required type="hidden" class="form-control"
                                    placeholder="Masukkan Nomor ID Permohonan" value="<?php echo $id ?>">
                            </div>

                            <div class="form-group has-feedback" align="left">
                                <label>3) NIK <p style="color: red; display: inline-block;">*</p></label>
                                <input name="nik" required type="text" class="form-control"
                                    placeholder="NIK wajib diisi">
                            </div>
                        ...
                        <div class='col-md-6'>
                            ...
                            <div class="form-group has-feedback" align="left">
                                <label>8) Alokasi Volume BBM (liter / hari) <p
                                        style="color: red; display: inline-block;">*</p></label>
                                <input name="volume_bbm_harian" type="text" class="form-control"
                                    placeholder="Tuliskan angka & huruf, contoh : 25 (dua puluh lima)" required>
                            </div>
                            ...
                            <div class='row'>
                                ...
                                <div align="left" class='form-group' style="margin-left: 17px;">
                                    ...
                                    <select id="jenis_usaha" class="form-control"
                                        onchange="populate(this.value,'jenis_alat')" required>
                                        <option value=''>Pilih</option>
                                        <?php
                                ...
                                <div align="left" class='form-group' style="margin-left: 17px;">
                                    ...
                                    <select name='jenis_usaha_id' class='form-control' id='jenis_alat' disabled
                                        required></select>
                                </div>

                                <div align="left" class='form-group' style="margin-left: 17px;">
                                    <label>c) Nama Usaha <p style="color: red; display: inline-block;">*</p></label>
                                    <input name="nama_usaha" type="text" class="form-control"
                                        placeholder="Isikan alat yg digunakan...." required>
                    ...
                    <div class="row">
                        <div class="form-group has-feedback" align="left" style="margin-left: 17px;">
                            ...
                            <input name="nomor_induk_spbu" type="text" class="form-control"
                                placeholder="Isikan Nomor Induk SPBU" required>
                        </div>
                        ...
                        <div class="form-group has-feedback" align="left" style="margin-left: 17px;">
                            ...
                            <input name="nomor_rangka_mesin" type="text" class="form-control"
                                placeholder="Isikan Nomor Rangka Mesin" required>
                        </div>

                        <div class="form-group has-feedback" align="left" style="margin-left: 17px;">
                            <label class="form-label">13) Foto Mesin/Alat Penggerak <p
                                    style="color: red; display: inline-block;">*</p></label>
                            <input type="file" class="form-control" name="foto_mesin" required />
                        </div>

                        <div class="form-group has-feedback" align="left" style="margin-left: 17px;">
                            <label class="form-label">14) Foto KTP <p style="color: red; display: inline-block;">*</p>
                            </label>
                            <input type="file" class="form-control" name="foto_ktp" required />
                        </div>

                        <div class="form-group has-feedback" align="left" style="margin-left: 17px;">
                            <label class="form-label">15) Foto Keterangan Domisili Tempat Usaha dari Kepala Desa <p
                                    style="color: red; display: inline-block;">*</p></label>
