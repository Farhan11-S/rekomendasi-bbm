                            ...
                            <div class="modal-body">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td scope="row">KTP</td>
                                            <td><img id="foto_ktp" class="img-fluid img-thumbnail"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Mesin</td>
                                            <td><img id="foto_mesin" class="img-fluid img-thumbnail"></td>
                                        </tr>
                                        <tr>
                                            <td scope="row">Domisili</td>
                                            <td><img id="foto_domisili" class="img-fluid img-thumbnail"></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <div id="form_update">
